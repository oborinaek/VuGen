Action()
{
	...
	lr_start_transaction("general");

	lr_end_transaction("general",LR_AUTO);

	web_websocket_send("ID=1", 
		"Buffer={\"messageType\":\"hello\",\"broadcasts\":{\"remote-settings/monitor_changes\":\"\\\"1728408761493\\\"\"},\"use_webpush\":true}", 
		"IsBinary=0", 
		LAST);
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=userSession", "Value=140008.844795464HcAVHAtpQftVzzzHtDcVApccQHcf", ENDITEM, 
	...
	web_submit_data("reservations.pl", 
		...
		"Name=departDate", "Value=10/09/2024", ENDITEM, 
		"Name=arrive", "Value=Paris", ENDITEM, 
		"Name=returnDate", "Value=10/10/2024", ENDITEM, 
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=outboundFlight", "Value=141;166;10/09/2024", ENDITEM, 
		"Name=numPassengers", "Value=1", ENDITEM, 
		"Name=advanceDiscount", "Value=0", ENDITEM, 
		"Name=seatType", "Value=Business", ENDITEM, 
		"Name=seatPref", "Value=Window", ENDITEM, 
	...
	web_submit_data("reservations.pl_3", 
		...
		"Name=creditCard", "Value=3829472975205", ENDITEM, 
